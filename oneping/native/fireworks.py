...
def reply(query, image=None, history=None, system=DEFAULT_SYSTEM, api_key=None, model=FIREWORKS_MODEL, **kwargs):
...
async def reply_async(query, image=None, history=None, system=DEFAULT_SYSTEM, api_key=None, model=FIREWORKS_MODEL, **kwargs):
...
def stream(query, image=None, history=None, system=DEFAULT_SYSTEM, api_key=None, model=FIREWORKS_MODEL, **kwargs):
    client = make_client(api_key=api_key)
    payload = make_payload(query, image=image, system=system, history=history)
...
async def stream_async(query, image=None, history=None, system=DEFAULT_SYSTEM, api_key=None, model=FIREWORKS_MODEL, **kwargs):
    client = make_client(api_key=api_key, async_client=True)
    payload = make_payload(query, image=image, system=system, history=history)
