...
from ..providers import (
    DEFAULT_SYSTEM, ANTHROPIC_MODEL, payload_anthropic,
    response_anthropic_native, stream_anthropic_native
)

def get_llm_response(prompt, api_key=None, model=ANTHROPIC_MODEL, system=DEFAULT_SYSTEM, max_tokens=1024, **kwargs):
...
async def async_llm_response(prompt, api_key=None, model=ANTHROPIC_MODEL, system=DEFAULT_SYSTEM, max_tokens=1024, **kwargs):
